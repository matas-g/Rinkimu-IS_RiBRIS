        ...
        return (
              <form>
                ...
                <div className="form-group">
                    ...
                    <input className="form-control" type="text" required value={this.props.district.name} onChange={this.props.onFieldChange('name')} /><br />
                </div>
                <div className="form-group">
                    <label>Adresas</label>
                    <input className="form-control" type="text" required value={this.props.district.address} onChange={this.props.onFieldChange('address')} /><br />
                </div>
                <div className="form-group">
                    <label>Balsuotojų skaičius</label>
                    <input className="form-control" type="number"required value={this.props.district.numOfVoters} onChange={this.props.onFieldChange('numOfVoters')} /><br />
                </div>
